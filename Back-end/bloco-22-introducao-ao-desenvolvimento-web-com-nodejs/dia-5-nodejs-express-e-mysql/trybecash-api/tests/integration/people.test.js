...
describe('Testando os endpoints de people', function () {
  ...
  it('Testando a listagem de todas as pesssoas', async () => {
  ...
  it('Testando a chamada da pessoa com id 1', async () => {
  ...
  it('Testando a edicao de um dado da pessoa com id 1', async () => {
    ...
    expect(response.status).to.equal(200);
    expect(response.body).to.deep.equal({ message: 'Pessoa com id 1 atualizada com sucesso' });
  });

  it('Testando a exclusao da pessoa com id 1', async () => {
    sinon.stub(connection, 'execute').resolves([ { affectedRows: 1 } ]);
